#+title: protons vanilla emacs config
...
- [[#fonts][Fonts]]
  - [[#font-face][Font Face]]
  - [[#text-scalingzoom][Text scaling/Zoom]]
- [[#emacs-gui-configuration][Emacs GUI Configuration]]
  - [[#bars][Bars]]
...
Show some nice bullets instead of asterisks.
